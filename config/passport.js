...
module.exports = passport => {
    ...
    passport.use(new JwtStrategy(opts, function(jwt_payload, done) {
        ...
        if ( !connection )
            ...
            connection.query(`SELECT si_user.companyunits_idcompanyunits, si_user.idsi_user, si_user.nombre, si_user.email, si_user.si_rol_idsi_rol, si_user.super, si_user.is_deleted, s.idsi_sesion, s.estado
                                FROM si_user 
