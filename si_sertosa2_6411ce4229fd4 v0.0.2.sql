...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2023 a las 06:15:17
...
(9, 'AFRISA', 1, 'http://localhost:3000/company/afrisa_logo.jpg', 0, '2023-03-15 16:58:39', 1, '2023-04-14 15:23:30'),
(10, 'USA MEX', 1, 'http://localhost:3000/company/usamexcarrier_logo.jpg', 0, '2023-03-15 16:58:49', 1, '2023-04-14 15:23:41');
...
INSERT INTO `employee` (`idemployee`, `name`, `phone`, `si_user_idsi_user`, `companyunits_idcompanyunits`, `code`, `photo`, `is_deleted`, `created_at`, `created_by`, `modified_at`) VALUES
(44, 'PANCHO LOPEZ', 'pancho@lopez.com', 1, 1, '4321', 'http://localhost:3000/employee/294664133_149179647722196_3284977118345987498_n.png', 0, '2023-04-02 17:44:15', 1, '2023-04-16 18:17:11'),
(45, 'CESAR', 'cesar.desarrollo.web@gmai', 6, 1, '1234567', 'http://localhost:3000/employee/147404614-café-en-una-taza-y-un-platillo-sobre-un-fondo-antiguo-.jpg', 0, '2023-04-13 03:44:43', 1, '2023-04-16 18:17:01'),
(46, 'TESTx', 'test@test.com', 7, 1, '1234', 'http://localhost:3000/employee/2c6b3a70-7a84-4cbc-9d64-5a7af9acddc1.jpg', 0, '2023-04-16 16:24:51', 7, '2023-04-16 19:15:24'),
(49, 'JEFE DE ALMACEN JEFE JEFE', '53543252345', 8, 1, '4444', NULL, 0, '2023-05-17 00:43:00', 1, '2023-05-17 00:43:57'),
(50, 'mario r', '33241324123', 9, 19, '2345', 'http://localhost:3000/employee/2c6b3a70-7a84-4cbc-9d64-5a7af9acddc1.jpg', 0, '2023-05-21 17:46:59', 9, '2023-05-21 17:46:59');
...
CREATE TABLE `service_employee` (
  ...
  `validated` tinyint(1) DEFAULT 0 COMMENT '1|Orden de trabajo validada',
  `is_deleted` tinyint(1) DEFAULT 0 COMMENT '0|Baja lógica',
  `created_at` timestamp NULL DEFAULT current_timestamp() COMMENT '0|Fecha de creación',
  `created_by` int(11) DEFAULT NULL COMMENT '0|Creado por',
  `modified_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '0|Fecha de actualización'
...
CREATE TABLE `si_modulo` (
  ...
  `codigo` varchar(55) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '1|Código',
...
(1, 'EMPRESA', NULL, 'company', 0, 1, '2023-03-15 19:56:10', '2023-05-17 00:51:15'),
(2, 'GRUPO', NULL, 'companygroup', 0, 1, '2023-03-15 19:56:10', '2023-05-17 00:51:23'),
(3, 'UNIDADES', NULL, 'companyunits', 0, 1, '2023-03-15 19:56:10', '2023-05-17 00:51:29'),
(4, 'EMPLEADO', NULL, 'employee', 0, 1, '2023-03-15 19:56:10', '2023-05-17 00:51:39'),
(5, 'FAMILIA', NULL, 'family', 0, 1, '2023-03-15 19:56:11', '2023-04-02 19:29:18'),
(6, 'EDITAR', NULL, 'orderin', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:51:48'),
(7, 'ORDEN SALIDA', NULL, 'orderout', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:51:56'),
(8, 'REFACCIÓN', NULL, 'product', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:52:04'),
(9, 'REPARACIONES', NULL, 'project', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:25:15'),
(10, 'SERVICIO EN REP', NULL, 'project_service', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:52:26'),
(11, 'PROVEDOR', NULL, 'provider', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:52:39'),
(12, 'SERVICIO', NULL, 'service', 0, 1, '2023-03-15 19:56:11', '2023-05-17 00:52:48'),
(13, 'TRABAJANDO', NULL, 'service_employee', 0, 1, '2023-03-15 19:56:12', '2023-04-13 04:26:14'),
(14, 'ALERTAS', NULL, 'si_alerta', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:53:23'),
(15, 'DEVICES', NULL, 'si_device', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:53:31'),
(16, 'LOGS', NULL, 'si_log', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:53:53'),
(17, 'MÓDULOS', NULL, 'si_modulo', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:54:10'),
(18, 'PERMISOS', NULL, 'si_permiso', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:54:37'),
(19, 'ROLES', NULL, 'si_rol', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:54:42'),
(20, 'ROL PERMISO', NULL, 'si_rol_permiso', 0, 1, '2023-03-15 19:56:12', '2023-05-17 00:54:49'),
(21, 'SESIÓN', NULL, 'si_sesion', 0, 1, '2023-03-15 19:56:13', '2023-05-17 00:54:56'),
(22, 'SESIÓN ESTADO', NULL, 'si_sesionestado', 0, 1, '2023-03-15 19:56:13', '2023-05-17 00:55:08'),
(23, 'USUARIOS', NULL, 'si_user', 0, 1, '2023-03-15 19:56:13', '2023-05-17 00:55:15'),
(24, 'USUARIO ROL', NULL, 'si_user_rol', 0, 1, '2023-03-15 19:56:13', '2023-05-17 00:55:21'),
(25, 'SOL. PROV.', NULL, 'solicitudeprovider', 0, 1, '2023-03-15 19:56:13', '2023-05-17 00:55:30'),
...
(34, 'TRAB. ESTADOS', NULL, 'service_employeeestado', 0, 1, '2023-04-17 22:36:07', '2023-04-17 22:36:07');
...
CREATE TABLE `si_permiso` (
  ...
  `validateServiceEmployee` tinyint(1) DEFAULT 0 COMMENT '1|Valida Orden Trabajando',
  `is_deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0|Eliminado',
  `created_by` int(10) NOT NULL COMMENT '0|Creado por',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '0|Fecha de creación',
  `modified_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '0|Fecha de modificación'
...
(65, NULL, NULL, 'ESTADOS DE TRABAJANDO', 6, 34, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1, '2023-05-16 23:54:54', '2023-05-16 23:54:54'),
(66, NULL, NULL, 'REPARACIONES MECANICO', 6, 9, 1, 1, 1, 1, 1, NULL, NULL, NULL, NULL, NULL, 0, 1, '2023-05-17 00:24:54', '2023-05-17 00:24:54');
...
(8, 'JEFE DE ALMACEN', 'JEFE', 'DEALMACEN', 'jefealmacen@sertosa.com', 0x24326224313024364537534d794558436d714f6d762f694f374e4679757665437a4d79354856796b587951556436693778436a5251794f6f4a526771, 3, 1, 'ACTIVO', 'ieyk8rmxszaeuqy8dzy3', 0, '2023-05-17 00:31:59', 0, 1, '2023-05-17 00:31:59', '2023-05-17 00:31:59'),
(9, 'MARIO', 'REPARTIDOR', 'GONZALES', 'marior@gmail.com', 0x243262243130247331696c47516442554f54755230334b6a61344a6b4f364843505133535443437167797375504a707262794f4a716674306e374336, 7, 20, 'ACTIVO', 'gh4y4cs032strja93jju', 0, '2023-05-21 17:46:33', 0, 1, '2023-05-21 17:46:33', '2023-05-21 17:46:33');
...
--
ALTER TABLE `company`
  MODIFY `idcompany` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `companygroup`
--
ALTER TABLE `companygroup`
  MODIFY `idcompanygroup` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `companyunits`
--
ALTER TABLE `companyunits`
  MODIFY `idcompanyunits` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `employee`
--
ALTER TABLE `employee`
  MODIFY `idemployee` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=51;
...
--
ALTER TABLE `si_modulo`
  MODIFY `idsi_modulo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT de la tabla `si_permiso`
--
ALTER TABLE `si_permiso`
  MODIFY `idsi_permiso` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=67;
...
--
ALTER TABLE `si_user`
  MODIFY `idsi_user` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=10;
...
--
ALTER TABLE `warehouse`
  MODIFY `idwarehouse` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '0|', AUTO_INCREMENT=4;
